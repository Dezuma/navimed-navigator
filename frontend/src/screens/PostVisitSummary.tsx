        ...
        <div className="nm-card" style={{ marginTop: 14 }}>
          <div style={{ background: "#7dd3c7", borderRadius: 8, padding: 8, marginBottom: 6 }}>
            ...
            <div style={{ fontSize: "0.8rem" }}>
              Medical context is available for vitals, labs, conditions, and care gaps.
            </div>
          </div>
          <div style={{ background: "#f8fafc", borderRadius: 8, padding: 8, marginBottom: 6 }}>
            ...
            <ul style={{ margin: "6px 0 0 16px", padding: 0, fontSize: "0.78rem", lineHeight: 1.3 }}>
              {patientMedicalProfile.conditions.map((item) => (
                <li key={item}>{item}</li>
              ))}
              <li>Medication: {patientMedicalProfile.medications[0]}</li>
              <li>Allergy: {patientMedicalProfile.allergies[0]}</li>
            </ul>
          </div>
          <div style={{ background: "#f8fafc", borderRadius: 8, padding: 8 }}>
            ...
            <ul style={{ margin: "6px 0 0 16px", padding: 0, fontSize: "0.78rem", lineHeight: 1.3 }}>
              {patientMedicalProfile.careGaps.map((item) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </div>
